 ...
 * Description :
 */
public class UiLibDialogListIos extends UiLibDialogImp {

    private ListView mListView;

    private SimpleAdapter mAdapter;

    protected UiLibDialogListIos(@NonNull Context context, int themeResId, int layoutResID) {
    ...
    private void initListView(String[] arrText, final ListOnItemClickListener listener) {
        ...
        View footerView = View.inflate(mContext, R.layout.uilib_layout_dialog_list_ios_footer, null);
