package com.tgs.topgamers.lib.uilib.timeselector;
...
import com.tgs.topgamers.lib.uilib.timeselector.view.PickerView;
import com.tgs.topgamers.lib.uilib.utils.DateUtil;
import com.tgs.topgamers.lib.uilib.utils.ScreenUtil;
import com.tgs.topgamers.lib.uilib.utils.TextUtil;
...
public class TimeSelector {
    ...
    private void initDialog() {
        if (seletorDialog == null) {
            seletorDialog = new Dialog(context, R.style.uilib_time_dialog);
            seletorDialog.setCancelable(false);
            seletorDialog.requestWindowFeature(Window.FEATURE_NO_TITLE);
            seletorDialog.setContentView(R.layout.uilib_dialog_selector);
